...
from models.utils import StraightThrough, AvgPoolConv, En_Decoding2
...
class SpikeModel(Module):
    def __init__(self, model: Module, sim_length: int, specials: dict = {}):
        super().__init__()
        self.model = model
    ...
    def spike_module_refactor(self, module: Module, sim_length: int, prev_module=None):
        """
        Recursively replace the normal conv2d to SpikeConv2d
        :param module: Module with Conv2d or Linear in its children
        ...
        for name, immediate_child_module in module.named_children():
            ...
            # new = StraightThrough()
            if isinstance(immediate_child_module, ReLU):
